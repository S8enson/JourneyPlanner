...
public class RoutePlannerTest {
    ...
    {   System.out.println("------ JOURNEY PLANNER -----");
        ...
        {   System.out.println("\nJourney Option "+(i+1)+": "+options.get(i));
        }
    }
    ...
    {   
        ...
        private static class JourneyComparator implements Comparator<BusJourney>{

        public JourneyComparator() {
        }

        @Override
        public int compare(BusJourney arg0, BusJourney arg1) {
            return arg0.getDestinationTime().compareTo(arg1.getDestinationTime());
        }
    }
}
